 ...
 */
@RestController
@RequestMapping("act/sms")
@Api(value = "act/sms", description = "发送短信")
public class ASmsLogController extends BaseController {
    ...
    public ResponseInfo sendMobileCode(@RequestParam String mobile,
                                       @ApiParam(name = "type", value = "短信类型",
                                               allowableValues = "act_pay_pwd, act_bank_bind, act_forgetPwd, act_loginPwd")
