...
@Api(value = "api/captcha.jpg", description = "h5注册图形验证码")
public class MKaptchaController extends BaseController {
    ...
    public void kaptcha(HttpSession session, HttpServletResponse response) throws IOException {
        ...
        //保存到session
        session.setAttribute(Constant.MKAPTCHA_SESSION_KEY, capText);
