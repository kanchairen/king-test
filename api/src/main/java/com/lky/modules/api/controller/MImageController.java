...
@Api(value = "api/image", description = "图片操作")
public class MImageController extends BaseController {

    @Inject
    private ImageService imageService;

    @ApiOperation(value = "单张图片上传", response = ImageDto.class, notes = "image 图片")
    @ApiImplicitParams({
