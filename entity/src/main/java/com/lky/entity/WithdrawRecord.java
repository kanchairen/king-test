...
@Data
@Entity
@Table(name = "m_withdraw_record")
@ApiModel(value = "WithdrawRecord", description = "大米提现记录")
public class WithdrawRecord extends BaseEntity {
    ...
    @ManyToOne
    @JoinColumn(nullable = false, name = "m_bank_card_id")
    private BankCard bankCard;

    @ApiModelProperty(notes = "提现记录状态（提现申请、提现中、提现失败、提现完成）",
            allowableValues = "apply,agree,failure,finish")
